...
public class FeuerwehrAuswahlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feuerwehr_auswahl);
    ...
    public void buildmessage(){
        ...
        if(r1){
            message += " An meiner Position Brennt es. ";
        }
        if(r2){
            message += " Ich befinde mich in einer Notlage. ";
        }
        if(r2){
