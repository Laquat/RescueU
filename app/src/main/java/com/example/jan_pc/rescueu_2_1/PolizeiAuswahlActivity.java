...
public class PolizeiAuswahlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polizei_auswahl);
    ...
    public void buildmessage(){
        ...
        if(r1){
            message += " An meiner Position Findet eine Überfall statt. ";
        }
        if(r2){
            message += " An meiner Position Findet eine Einbruch statt. ";
        }
        if(r2){
            message += " An meiner Position Findet eine Schlägerei statt. ";
        }
